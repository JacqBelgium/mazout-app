...
def init_db_if_needed():
    try:
        ...
        print(f"Fout bij DB-initialisatie: {e}")
...
def run_engine():
    ...
    try:
        ...
        print(f"Fout bij uitlezen DB: {e}")
    ...
    # Veilige fallback als de database-file nog leeg of onbereikbaar is
    short_term = {
        'latest_market_liter': 0.609,
        'latest_eur_ton': 725.50,
        'predicted_official_liter': 0.8195,
